...
const POLICY_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      "ErMate clinical reasoning support.",
  ...
  {
    icon: "cpu" as const,
    title: "5. ErMate Processing",
    items: [
      "Certain features (such as decision support, smart dictation, and reference chat) process clinical information using ErMate's clinical processing engine.",
      "Only necessary clinical information is processed.",
      "ErMate's processing is used solely to generate clinical assistance outputs.",
      "ErMate does not allow any third-party provider to independently store or use patient data for unrelated purposes.",
      "Doctors are advised to avoid entering unnecessary personally identifiable information.",
      "ErMate suggestions are for clinical decision support only and do not replace physician judgment.",
    ],
  },
  {
