...
export default function CaseSheetScreen() {
  ...
  const handleSave = async (silent: boolean = false) => {
    ...
    try {
      ...
      const payload: any = {
        vitals_at_arrival: {
          hr: parseFloat(formData.circulation.hr) || null,
          bp_systolic: parseFloat(formData.circulation.bpSystolic) || null,
          bp_diastolic: parseFloat(formData.circulation.bpDiastolic) || null,
          rr: parseFloat(formData.breathing.rr) || null,
          spo2: parseFloat(formData.breathing.spo2) || null,
          temperature: parseFloat(formData.exposure.temperature) || null,
          gcs_e: gcsE,
          gcs_v: gcsV,
          gcs_m: gcsM,
          gcs_total: gcsTotal,
          grbs: parseFloat(formData.disability.glucose) || null,
          pain_score: null,
        },
        primary_assessment: {
          ...
          breathing_rr: parseFloat(formData.breathing.rr) || null,
          breathing_spo2: parseFloat(formData.breathing.spo2) || null,
          breathing_oxygen_device: formData.breathing.o2Device || "",
          breathing_oxygen_flow: parseFloat(formData.breathing.o2Flow) || null,
          ...
          circulation_hr: parseFloat(formData.circulation.hr) || null,
          circulation_bp_systolic: parseFloat(formData.circulation.bpSystolic) || null,
          circulation_bp_diastolic: parseFloat(formData.circulation.bpDiastolic) || null,
          ...
          disability_grbs: parseFloat(formData.disability.glucose) || null,
          ...
          exposure_temperature: parseFloat(formData.exposure.temperature) || null,
        ...
        examination: {
          ...
          cvs_pulse_rate: parseInt(examData.cvs.pulseRate) || null,
